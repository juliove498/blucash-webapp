        ...
        <div className="flex-1 px-6 py-6 overflow-y-auto pb-safe">
          ...
          <div className="">
            <motion.button
              ...
              className="py-4 bg-[#2952E8] text-white rounded-2xl font-semibold flex items-center justify-center gap-2 shadow-md hover:bg-[#1e42cc] transition-colors w-full"
            >
              <svg
                className="w-5 h-5"
                fill="none"
